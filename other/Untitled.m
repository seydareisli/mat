...
%}
  ...
  % remove baseline
    ...
    save([subSavePath,'subjectERPs.mat'],'t','subjectERPs','subIDs','subGrps','avgBlockERPs','conds4blocks','rejType','cases','msBaseRemoved');
